library flutter_collapsable_toolbar;

import 'package:flutter/material.dart';
import 'package:carousel_hero/carousel_hero.dart';

class ScreenProjectDetail extends StatefulWidget {
  ...
  @override
  _ScreenProjectDetailState createState() => _ScreenProjectDetailState();
}

double expandedHeight = 250.0;

class _ScreenProjectDetailState extends State<ScreenProjectDetail> {
  double opacity = 0.0;
